...
import { DownOutlined,PlayCircleOutlined,PauseCircleOutlined } from '@ant-design/icons';
    ...
    render() {
        ...
        return (
            <div>
                ...
                {isPlay ? (
                    <div onClick={this.pauseAudio}><PauseCircleOutlined width="20px" height="20px"/></div>
                ) : (
                        <div onClick={this.playAudio}><PlayCircleOutlined /></div>
